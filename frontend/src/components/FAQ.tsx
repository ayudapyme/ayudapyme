  ...
  const faqs = [
    {
      ...
      answer: "Una vez recibida toda la documentación necesaria, nuestro equipo procesa las solicitudes en un plazo máximo de 24-48 horas laborables. Para trámites más complejos, te informaremos del plazo estimado de forma personalizada.",
    },
    {
      question: "¿Qué documentación necesito aportar?",
      answer: "La documentación varía según el trámite. Como mínimo necesitaremos tu identificación (NIF/CIF/NIE) y los datos de tu actividad. Para trámites específicos, te indicaremos exactamente qué documentos son necesarios una vez inicies el proceso.",
    },
    {
      question: "¿Cómo se realiza el pago?",
      answer: "Trabajamos con domiciliación bancaria SEPA, lo que garantiza la máxima seguridad en tus transacciones. Solo necesitas proporcionarnos tu IBAN y autorizar el cargo. Recibirás un desglose detallado de los servicios antes de cualquier cobro.",
    },
    {
      question: "¿Puedo hacer seguimiento de mi trámite?",
      answer: "Por supuesto. Una vez iniciado el proceso, recibirás actualizaciones por email en cada etapa. Además, puedes contactarnos en cualquier momento para consultar el estado de tu gestión.",
    },
    {
      question: "¿Qué tipo de empresas pueden utilizar vuestros servicios?",
      answer: "Atendemos a todo tipo de empresas: autónomos, microempresas, pymes y grandes empresas. Nuestros servicios se adaptan a las necesidades específicas de cada tipo de negocio.",
    },
    {
